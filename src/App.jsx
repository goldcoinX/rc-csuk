...
import { 
  Menu, X, Phone, Globe, MessageCircle, Star, Calendar, CreditCard, 
  CheckCircle2, ChevronDown, MapPin, ShieldCheck, Camera, Clock, 
    ...
    <div className="min-h-screen font-sans text-gray-800 flex flex-col">
      ...
      <div className="bg-white px-4 py-2 flex justify-between items-center text-sm border-b">
        <div className="flex gap-3 text-blue-600">
          <FacebookIcon className="cursor-pointer hover:opacity-70" />
